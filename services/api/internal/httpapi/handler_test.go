...
func (stubProfiles) Get(context.Context, string) (profile.Profile, error) { return profile.Profile{}, profile.ErrNotFound }
func (stubProfiles) Upsert(context.Context, string, profile.Profile) (profile.Profile, error) { return profile.Profile{}, nil }
