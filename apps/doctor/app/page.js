...
const features = [
  { icon: Users, eyebrow: "Patient access", title: "Shared patients", description: "Open records only through an active patient sharing grant or an approved clinical workflow.", action: "Foundation ready" },
  ...
  return (
    <AppShell audience="Doctor app" actions={<button className="rounded-xl bg-aid-ink px-3 py-2 text-xs font-bold text-white">Sign in</button>}>
      <section className="pb-8 pt-14 md:pt-20">
        ...
        <div className="glass mt-8 flex max-w-2xl items-center gap-3 rounded-2xl px-4 py-3">
